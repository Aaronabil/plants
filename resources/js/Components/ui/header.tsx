      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
                  ...
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="text-sm leading-tight text-blue-100">
                            Browse our complete collection of indoor and outdoor furniture
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        ...
                        >
                          <div className="text-sm font-medium leading-none">Indoor</div>
                          <p className="line-clamp-2 text-sm leading-snug text-gray-500">
                            Sofas, tables, chairs, and more for your interior
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-gray-500">
                            Garden furniture, patio sets, and outdoor decor
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
          ...
          <div className="flex items-center space-x-4">
            <button
              className="hidden md:inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 w-10"
              aria-label="Profile"
            >
            ...
            <button
              className="hidden md:inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 w-10 relative"
            ...
            {/* Mobile Menu Button */}
            <button
              className="inline-flex md:hidden items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 w-10"
              aria-label="Menu"
            >
